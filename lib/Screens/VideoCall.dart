...
import 'package:health_app/data/Settings.dart';
...
class BroadcastPage extends StatefulWidget {
  ...
  final bool isAdmin;
  final String uid;
  const BroadcastPage({Key key, this.channelName, this.isBroadcaster,this.isAdmin,this.uid}) : super(key: key);
...
class _BroadcastPageState extends State<BroadcastPage> {
  ...
  void del()async{
    ...
    uids  =  widget.uid;
    String  documentID="";
    var collection = await FirebaseFirestore.instance.collection('online').where('uid',isEqualTo: uids);
    var querySnapshots = await collection.get();
    for (var snapshot in querySnapshots.docs) {
      documentID = snapshot.id; // <-- Document ID

    }
    CollectionReference reference = FirebaseFirestore.instance.collection("online");
    reference.doc(documentID).delete();
    }
    }
  void getuid() async{
    if(widget.isAdmin) {
...
//    await reference.add(additems);
     ...
     //////////// print("hellllllllllllllllllllllllllllllllllllllll/n\nlhkhjgjgjj\ngfyryj");
      reference.add(add);
    }
    else{
